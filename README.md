...
to get the addresses for the properties using their latitude and longitude. The data after applying steps 1 and 2 is stored in [data/augmented_data_0719](data/augmented_data_0719.csv) and [data/augmented_data_0320](data/augmented_data_0320.csv).
#### Step3:
